...
(function(window, document) {
   ...
   /* ----------------------- Sounds ------------------------ */
   var Music = Juicy.Music = function() {
      this.sounds = {};
      this.volume = 0.3;
   };

   Music.prototype.load = function(name, src) {
      if (!src) {
         src = name;
      }
   ...
   Music.prototype.play = function(name) {
      if (this.sounds[name]) {
         this.sounds[name].play();
      }
   }

   Music.prototype.pause = function(name) {
      if (this.sounds[name]) {
         this.sounds[name].pause();
      }
   }

   Music.prototype.setVolume = function(newVol) {
      this.volume = newVol;
...
<<<<<<< HEAD
   var SFX = Juicy.SFX = function() {
      this.sounds = {};
      this.volume = 0.3;
   };

   SFX.prototype.load = function(name, src) {
      if (!src) {
         src = name;
=======
   Sound.load = function(name, src, loop) {
      ...
      if (loop) {
         sound.loop = "loop";
>>>>>>> d3863dd99c7967aae36e85872567e530c348117d
      }
   ...
   SFX.prototype.setVolume = function(newVol) {
      this.volume = newVol;
   ...
   window.compute = function() {
      ...
      console.log('FPS:', sec_per_frame.length / tot);
   }
...
(function(Juicy, Entity) {
   ...
   Juicy.Point.prototype.rotate = function(angle) {
      ...
      return new Juicy.Point(cos * this.x - sin * this.y,
